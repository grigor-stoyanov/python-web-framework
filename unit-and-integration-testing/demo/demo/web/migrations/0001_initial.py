    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('first_name', models.CharField(max_length=25, validators=[demo.web.models.validate_only_letters])),
                ('last_name', models.CharField(max_length=25, validators=[demo.web.models.validate_only_letters])),
